...
export var WEB_TO_RN_MAP = {
  ...
  '/messages': SCREENS.CONVERSATIONS,
  '/messages/:id': SCREENS.FRIEND_CHAT,
  '/ai': SCREENS.AI_CHAT_LIST,
  '/ai/:id': SCREENS.AI_CHAT,
...
export var LINKING_CONFIG = {
  ...
  config: {
    screens: {
      ...
      DreamJournal: 'dream/:id/journal',
      FocusTimer: 'focus-timer',
      VisionBoard: 'vision-board',
      MicroStart: 'micro-start/:dreamId',
      SharedDreams: 'dreams/shared',
      DreamTemplates: 'dream/templates',
      GoalRefine: 'dream/goal-refine',
      AIChat: 'ai/:id',
      BuddyChat: 'buddy-chat/:id',
      CircleChat: 'circle-chat/:id',
      VoiceCall: 'voice-call/:id',
      VideoCall: 'video-call/:id',
      CallHistory: 'calls/history',
      UserProfile: 'user/:id',
      CircleDetail: 'circle/:id',
      CircleCreate: 'circles/create',
      CircleChallenges: 'circle/:id/challenges',
      Explore: 'explore',
      ...
      AccountabilityContract: 'buddy/:id/contract',
      SavedPosts: 'social/saved',
      PostDetail: 'post/:id',
      GoogleCalendarConnect: 'calendar-connect',
      TimeBlocks: 'calendar/timeblocks',
      GoogleSyncSettings: 'calendar/sync-settings',
      SharedCalendarView: 'calendar/shared/:id',
      TimeBlockTemplates: 'calendar/timeblock-templates',
      Settings: 'settings',
      ...
      Gifting: 'store/gifts',
      Referral: 'referral',
      SeasonDetail: 'league/season/:id',
      GroupLeaderboard: 'leagues/group/:groupId',
      Notifications: 'notifications',
