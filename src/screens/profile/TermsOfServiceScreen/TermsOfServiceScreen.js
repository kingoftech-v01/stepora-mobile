/**
 * TermsOfServiceScreen -- React Native.
 * Ported from TermsOfServiceMobile.jsx (web app).
 */
var React = require('react');
var { View, Text, ScrollView, TouchableOpacity, StyleSheet } = require('react-native');
var useTermsOfServiceScreen = require('./useTermsOfServiceScreen');
var { BRAND } = require('../../../styles/colors');
var { dark } = require('../../../styles/theme');

function TermsOfServiceScreen() {
  var h = useTermsOfServiceScreen();
...
var styles = StyleSheet.create({
  ...
  docDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: BRAND.purpleLight },
...
module.exports = TermsOfServiceScreen;
