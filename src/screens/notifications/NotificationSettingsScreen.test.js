...
jest.mock("../../services/pushNotifications", function () { return { registerTokenWithBackend: jest.fn(), requestPermission: jest.fn(function () { return Promise.resolve(true); }), checkPermission: jest.fn(function () { return Promise.resolve(true); }) }; });
...
var Screen = require('./NotificationSettingsScreen');

describe('NotificationSettingsScreen', function () {
