jest.mock("react-native-agora", function () { return { RtcEngine: { create: jest.fn() }, VideoRenderMode: {}, ChannelProfile: {}, ClientRole: {} }; });
...
var Screen = require('./VideoCallScreen');

describe('VideoCallScreen', function () {
