...
export interface IRtcEngineEventHandler {
     ...
     */
    onLocalVideoStats?(connection: RtcConnection, sourceType: VideoSourceType, stats: LocalVideoStats): void;
    /**
...
export declare abstract class IRtcEngine {
     ...
     *  < 0: Failure. See [Error Codes](https://docs.agora.io/en/video-calling/troubleshooting/error-codes) for details and resolution suggestions.
     */
    abstract setPlaybackAudioFrameBeforeMixingParameters(sampleRate: number, channel: number, samplesPerCall: number): number;
    /**
     ...
     * @ignore
     */
    abstract sendRdtMessage(uid: number, type: RdtStreamType, data: string, length: number): number;
    /**
     * @ignore
     */
    abstract sendMediaControlMessage(uid: number, data: string, length: number): number;
    /**
