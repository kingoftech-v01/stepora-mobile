...
export declare abstract class IRtcEngineEx extends IRtcEngine {
     ...
     * @ignore
     */
    abstract sendRdtMessageEx(uid: number, type: RdtStreamType, data: string, length: number, connection: RtcConnection): number;
    /**
     * @ignore
     */
    abstract sendMediaControlMessageEx(uid: number, data: string, length: number, connection: RtcConnection): number;
    /**
     ...
     *  < 0: Failure.
     */
    abstract removeVideoWatermarkEx(id: string, connection: RtcConnection): number;
    /**
     ...
     *  < 0: Failure.
     */
    abstract addVideoWatermarkWithConfigEx(config: WatermarkConfig, connection: RtcConnection): number;
}
