import { ChannelMediaRelayConfiguration, ConnectionStateType, DataStreamConfig, EncryptionConfig, LiveTranscoding, RdtStreamType, SimulcastConfig, SimulcastStreamConfig, SimulcastStreamMode, SpatialAudioParams, UserInfo, VideoCanvas, VideoEncoderConfiguration, VideoMirrorModeType, VideoStreamType, VideoSubscriptionOptions, WatermarkConfig, WatermarkOptions } from '../AgoraBase';
...
export declare class IRtcEngineExImpl extends IRtcEngineImpl implements IRtcEngineEx {
    ...
    protected getApiTypeFromSendRdtMessageEx(uid: number, type: RdtStreamType, data: string, length: number, connection: RtcConnection): string;
    sendMediaControlMessageEx(uid: number, data: string, length: number, connection: RtcConnection): number;
    protected getApiTypeFromSendMediaControlMessageEx(uid: number, data: string, length: number, connection: RtcConnection): string;
    ...
    protected getApiTypeFromRemoveVideoWatermarkEx(id: string, connection: RtcConnection): string;
    ...
    addVideoWatermarkWithConfigEx(config: WatermarkConfig, connection: RtcConnection): number;
    protected getApiTypeFromAddVideoWatermarkWithConfigEx(config: WatermarkConfig, connection: RtcConnection): string;
}
