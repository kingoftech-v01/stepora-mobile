...
export declare class IRtcEngineImpl implements IRtcEngine {
    ...
    protected getApiTypeFromSetPlaybackAudioFrameBeforeMixingParameters(sampleRate: number, channel: number, samplesPerCall: number): string;
    ...
    protected getApiTypeFromSendRdtMessage(uid: number, type: RdtStreamType, data: string, length: number): string;
    sendMediaControlMessage(uid: number, data: string, length: number): number;
    protected getApiTypeFromSendMediaControlMessage(uid: number, data: string, length: number): string;
    ...
    protected getApiTypeFromAddVideoWatermarkWithConfig(configs: WatermarkConfig): string;
