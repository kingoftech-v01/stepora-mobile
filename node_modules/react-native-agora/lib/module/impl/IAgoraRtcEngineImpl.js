  ...
  switch (event) {
    ...
    case 'onLocalVideoStats':
      if (handler.onLocalVideoStats !== undefined) {
        handler.onLocalVideoStats(jsonParams.connection, jsonParams.sourceType, jsonParams.stats);
      }
      break;
    ...
    case 'onRdtMessage':
      if (handler.onRdtMessage !== undefined) {
        handler.onRdtMessage(jsonParams.connection, jsonParams.userId, jsonParams.type, jsonParams.data, jsonParams.length);
      }
      break;
    case 'onRdtStateChanged':
      if (handler.onRdtStateChanged !== undefined) {
        handler.onRdtStateChanged(jsonParams.connection, jsonParams.userId, jsonParams.state);
      }
      break;
    case 'onMediaControlMessage':
      if (handler.onMediaControlMessage !== undefined) {
        handler.onMediaControlMessage(jsonParams.connection, jsonParams.userId, jsonParams.data, jsonParams.length);
      }
      break;
    case 'onRequestToken':
    ...
    case 'onRenewTokenResult':
      if (handler.onRenewTokenResult !== undefined) {
        handler.onRenewTokenResult(jsonParams.connection, jsonParams.token, jsonParams.code);
      }
      break;
  }
}
...
export class IRtcEngineImpl {
  ...
  setPlaybackAudioFrameBeforeMixingParameters(sampleRate, channel, samplesPerCall) {
    const apiType = this.getApiTypeFromSetPlaybackAudioFrameBeforeMixingParameters(sampleRate, channel, samplesPerCall);
    const jsonParams = {
      sampleRate: sampleRate,
      channel: channel,
      samplesPerCall: samplesPerCall,
  ...
  getApiTypeFromSetPlaybackAudioFrameBeforeMixingParameters(sampleRate, channel, samplesPerCall) {
  ...
  sendRdtMessage(uid, type, data, length) {
  ...
  getApiTypeFromSendRdtMessage(uid, type, data, length) {
    return 'RtcEngine_sendRdtMessage_ea5e5d7';
  }
  sendMediaControlMessage(uid, data, length) {
    const apiType = this.getApiTypeFromSendMediaControlMessage(uid, data, length);
    const jsonParams = {
      uid: uid,
      data: data,
      length: length,
  ...
  getApiTypeFromSendMediaControlMessage(uid, data, length) {
  ...
  getApiTypeFromRemoveVideoWatermark(id) {
  ...
  addVideoWatermarkWithConfig(configs) {
  ...
  getApiTypeFromAddVideoWatermarkWithConfig(configs) {
